...
def render_page(pdf_path: str, page_num: int, dpi: int = 150) -> str:
...
def extract_from_image(client: anthropic.Anthropic, img_b64: str, retries: int = 3) -> dict:
        ...
        for i, pdf_path in enumerate(pdf_files):
            ...
            for pg in range(n_pages):
                ...
                try:
                    ...
                    data = extract_from_image(client, img_b64)
